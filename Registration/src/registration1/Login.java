...
public class Login {
     ...
     String passMessage = "Password not formatted correctly, please ensure that your "
             + " contains at least 8 char, a capital letter, a number and a special char";
    String nameMessage = "Username is not correctly formatted, please ensure that your "
                    + "username contains an underscore and is not longer than 5 characters in length";
